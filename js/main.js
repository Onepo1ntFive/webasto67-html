...
(function () {
  ...
  if (document.querySelector('.js-filter')) {
    ...
    var filterDesktopBlock = document.querySelector('.js-filter-desktop'); // hide desktop
...
(function () {
  ...
  if (document.querySelector('.js-modal-show-cart')) {
    var modalCartShow = document.querySelector('.js-modal-show-cart');
    var modalCartCLoseBtns = document.querySelectorAll('.js-modal-hide-cart');
    var modalCart = document.querySelector('.js-modal-cart');
    var modalCartBg = document.querySelector('.js-modal-cart-bg');
    modalCartShow.addEventListener('click', function (event) {
      event.preventDefault();
      showModal(modalCart, modalCartBg);
    });
    Array.prototype.forEach.call(modalCartCLoseBtns, function (modalCartCLose) {
  ...
  Array.prototype.forEach.call(menuAchors2, function (el, i) {
    el.addEventListener('click', function (event) {
      ...
      if (event.target.parentNode.parentNode.classList.contains('js-menu-item-2')) {
        ...
        backBtn.innerHTML = "\u041D\u0430\u0437\u0430\u0434 \u0432 ".concat(event.target.parentNode.parentNode.parentNode.querySelector('.sidebar__menu-item-spacer a').innerHTML);
        nextLevelHeight = nextLevel.offsetHeight;
        setHeight(mainLevel, nextLevelHeight);
      }
    });
